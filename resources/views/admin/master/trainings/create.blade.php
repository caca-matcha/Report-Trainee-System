    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-[10px] font-medium text-gray-500 dark:text-gray-400 uppercase tracking-widest">Pembuatan template program pelatihan baru.</p>
            </div>
        </div>
    </x-slot>
