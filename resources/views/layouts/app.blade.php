...
<head>
    ...
    <title>{{ config('app.name', 'Report Trainee') }}</title>
    ...
    <div x-data="{ 
        ...
        <aside 
            ...
            <div class="flex items-center h-16 border-b border-gray-200 dark:border-gray-800 shrink-0 overflow-hidden px-4"
                ...
                <div x-show="!sidebarMinimized" x-transition.opacity class="whitespace-nowrap overflow-hidden">
                    ...
                    <p class="text-[10px] text-indigo-500 dark:text-indigo-400 font-extrabold uppercase tracking-widest leading-none">
            ...
            <nav class="flex-1 py-6 space-y-1 overflow-y-auto scrollbar-hide transition-all duration-300"
                ...
                <a href="{{ route('dashboard') }}"
                    class="flex items-center rounded-xl text-sm font-medium transition-all duration-200 group
                          {{ request()->routeIs('dashboard') ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-600/20 dark:shadow-indigo-900/40' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-indigo-600 dark:hover:text-white' }}"
        ...
        <div class="flex-1 flex flex-col overflow-hidden bg-white dark:bg-gray-950">
            ...
            <header class="bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 h-16 flex-shrink-0 z-40 transition-colors duration-300">
                <div class="px-6 h-full flex items-center justify-between gap-4">
                    ...
                    <button @click="toggleTheme()" 
                            class="p-2.5 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-indigo-600 dark:hover:text-white transition-all duration-300 group"
                            title="Toggle Theme">
                        <!-- Sun Icon -->
                        <svg x-show="!darkMode" class="w-5 h-5 group-hover:rotate-12 transition-transform duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
