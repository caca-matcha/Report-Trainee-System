                    ...
                    <form method="POST" action="{{ route('trainings.update', $training) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="organizer" class="block mt-1 w-full" type="text" name="organizer"
                                ...
                                placeholder="Contoh: Dharma Learning Center" />
                        ...
                        <div class="mt-4">
                            ...
                            <select id="training_type" name="training_type"
                                ...
                                <option value="In House Training" {{ $training->training_type == 'In House Training' ? 'selected' : '' }}>In House Training</option>
                                <option value="Public Training" {{ $training->training_type == 'Public Training' ? 'selected' : '' }}>Public Training</option>
                            </select>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="passing_grade" class="block mt-1 w-full" type="number"
                                name="passing_grade" :value="old('passing_grade', $training->passing_grade)" min="0"
                                max="100" required />
